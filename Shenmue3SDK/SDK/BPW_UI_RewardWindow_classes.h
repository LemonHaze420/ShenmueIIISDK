...
// WidgetBlueprintGeneratedClass BPW_UI_RewardWindow.BPW_UI_RewardWindow_C
// 0x0038 (0x0240 - 0x0208)
class UBPW_UI_RewardWindow_C : public UUserWidget
{
public:
	...
	ES3RewardCategory                                  RewardCategory;                                           // 0x0228(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0229(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    ED_FinishAnim;                                            // 0x0230(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BPW_UI_RewardWindow.BPW_UI_RewardWindow_C");
		return ptr;
	}
