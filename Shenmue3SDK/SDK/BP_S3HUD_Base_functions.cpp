...
bool ABP_S3HUD_Base_C::ScreenFadeOut(float* FadeTime, struct FLinearColor* FadeColor)
{
...
bool ABP_S3HUD_Base_C::ScreenFadeIn(float* FadeTime, struct FLinearColor* FadeColor)
{
