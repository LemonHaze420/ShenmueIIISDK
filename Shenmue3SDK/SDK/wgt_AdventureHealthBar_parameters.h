...
struct Uwgt_AdventureHealthBar_C_Tick_Params
{
...
struct Uwgt_AdventureHealthBar_C_PreConstruct_Params
{
	bool*                                              IsDesignTime;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function wgt_AdventureHealthBar.wgt_AdventureHealthBar_C.ExecuteUbergraph_wgt_AdventureHealthBar
struct Uwgt_AdventureHealthBar_C_ExecuteUbergraph_wgt_AdventureHealthBar_Params
{
