...
public:
	...
	bool                                               bCanBeMiniGame;                                           // 0x02B8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x02B9(0x0007) MISSED OFFSET
	TArray<int>                                        NPCManageMiniGameIdTables;                                // 0x02C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ChangeMemoFlagIDList;                                     // 0x02D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
