...
void UUMG_SubTitleTextBottom_C::SetText(struct FString* Body, struct FST_RubyInfo* InRubyInfo, struct FLinearColor* InSubtitleColor, struct FLinearColor* InOutlineColor)
{
