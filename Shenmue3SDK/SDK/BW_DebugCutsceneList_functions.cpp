...
struct FEventReply UBW_DebugCutsceneList_C::OnKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
struct FEventReply UBW_DebugCutsceneList_C::OnPreviewKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
