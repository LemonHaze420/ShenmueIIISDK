...
enum class ES3ActionIconType : uint8_t
{
	...
	ES3ActionIconType__ES3ActionIconType_MAX = 30
};
...
{
	float                                              BestCourseTime;                                           // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	TArray<float>                                      BestMissionTimes;                                         // 0x0008(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               bClearFlag;                                               // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
