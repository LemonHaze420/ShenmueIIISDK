...
struct FEventReply UBW_FloatProperty_C::OnAnalogValueChanged(struct FGeometry* MyGeometry, struct FAnalogInputEvent* InAnalogInputEvent)
{
...
void UBW_FloatProperty_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
