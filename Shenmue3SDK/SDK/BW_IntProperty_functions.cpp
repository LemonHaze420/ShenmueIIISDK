...
struct FEventReply UBW_IntProperty_C::OnKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
void UBW_IntProperty_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
