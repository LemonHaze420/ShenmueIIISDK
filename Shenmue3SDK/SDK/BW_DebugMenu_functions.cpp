...
struct FEventReply UBW_DebugMenu_C::OnKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
struct FEventReply UBW_DebugMenu_C::OnPreviewKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
void UBW_DebugMenu_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
...
void UBW_DebugMenu_C::CustomEvent()
{
	static auto fn = UObject::FindObject<UFunction>("Function BW_DebugMenu.BW_DebugMenu_C.CustomEvent");

	UBW_DebugMenu_C_CustomEvent_Params params;
