...
public:
	...
	void ExspPosSet_B();
	void ExspPosSet();
	void InitSet(class UPrimitiveComponent* Door1, class UPrimitiveComponent* Door2, class UPrimitiveComponent* JoinTrigger, bool ParentSheSeparation);
	...
	void OnBeginOverLap_JoinTrigger(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	void OnEndOverlap_JoinTrigger(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex);
	void ExecuteUbergraph_BP_Hakkason_FlwOrNpc_New(int EntryPoint);
};
