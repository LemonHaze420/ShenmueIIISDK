...
public:
	...
	bool STATIC_PlayGacha(const struct FName& GachaId, struct FS3GachaItem* Out);
...
public:
	...
	bool                                               bIsDebugMenuOpen;                                         // 0x0318(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06[0x7];                                       // 0x0319(0x0007) MISSED OFFSET
	class UClass*                                      LoadingScreenWidgetClass;                                 // 0x0320(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FDateTime                                   EyecatchTime;                                             // 0x0328(0x0008) (BlueprintVisible)
	class US3LoadingWidget*                            LoadingScreenWidget;                                      // 0x0330(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData07[0x10];                                      // 0x0338(0x0010) MISSED OFFSET
	float                                              LoadingScreenProgress;                                    // 0x0348(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x5C];                                      // 0x034C(0x005C) MISSED OFFSET
	int                                                HintTalkDifficulty;                                       // 0x03A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               HintTalkPrintDebug;                                       // 0x03AC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void SetBattleRallyInfo(int Index, const struct FS3BattleRallyInfo& Info);
	void SetBattleRallyAlready(bool bAlready);
	...
	void GetBattleRallyInfo(bool* bAlready, TArray<struct FS3BattleRallyInfo>* InfoArray);
...
public:
	...
	void SetActiveMiniGame(class AS3MiniGameBase* MiniGame);
};
...
public:
	...
	class UClass*                                      SkipControllerClass;                                      // 0x0680(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class AS3SkipController*                           SkipController;                                           // 0x0688(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0690(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnFinishedLoadLevel;                                      // 0x06A0(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	bool                                               bLevelChangeFade;                                         // 0x06B0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x7];                                       // 0x06B1(0x0007) MISSED OFFSET
	TArray<class AS3SearchArea*>                       SearchAreaArray;                                          // 0x06B8(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	class UDataTable*                                  ItemDataTable;                                            // 0x06C8(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<class UClass*>                              GlobalPauseIgnoreClasses;                                 // 0x06D0(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	class AActor*                                      OverrideSpawnPoint;                                       // 0x06E0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class AActor*>                              DisableLSVActors;                                         // 0x06E8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x10];                                      // 0x06F8(0x0010) MISSED OFFSET
...
{
public:
	ES3BootState                                       BootState;                                                // 0x0708(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0709(0x0007) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnLoginCompleted;                                         // 0x0710(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	int                                                BuildNumber;                                              // 0x0068(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
	int                                                Changelist;                                               // 0x006C(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	struct FName                                       UnlockMeshId;                                             // 0x0090(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FString                                     Description;                                              // 0x0098(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
...
public:
	...
	TArray<struct FName>                               LoadRequestList;                                          // 0x0350(0x0010) (BlueprintVisible, ZeroConstructor)
	struct FName                                       LoadingCutscene;                                          // 0x0360(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FName>                               LoadedCutsceneList;                                       // 0x0368(0x0010) (BlueprintVisible, ZeroConstructor)
	bool                                               IsLoadingCutsceneFlag;                                    // 0x0378(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0379(0x0007) MISSED OFFSET
	TArray<struct FName>                               UnloadRequestList;                                        // 0x0380(0x0010) (BlueprintVisible, ZeroConstructor)
	struct FName                                       UnloadingCutscene;                                        // 0x0390(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUnloadingCutsceneFlag;                                  // 0x0398(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               IsUseFadeOutFlag;                                         // 0x0399(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x039A(0x0002) MISSED OFFSET
	float                                              FadeOutTime;                                              // 0x039C(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               LastCutsceneQTEResult;                                    // 0x03A0(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData03[0x2];                                       // 0x03F2(0x0002) MISSED OFFSET
...
public:
	...
	TArray<class AActor*>                              RegisteredOverlapActors;                                  // 0x0330(0x0010) (ZeroConstructor)
...
{
public:
	unsigned char                                      UnknownData00[0xB0];                                      // 0x03A8(0x00B0) MISSED OFFSET
...
public:
	...
	bool                                               bUseAvoidance;                                            // 0x0792(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1];                                       // 0x0793(0x0001) MISSED OFFSET
	float                                              AvoidanceInterpSpeed;                                     // 0x0794(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              WallStopDot;                                              // 0x0798(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              WallRunStopDot;                                           // 0x079C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUseCharacterStop;                                        // 0x07A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x07A1(0x0003) MISSED OFFSET
	float                                              CharacterStopDistance;                                    // 0x07A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ProjectionMultiplier;                                     // 0x07A8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              AvoidanceMultiplier;                                      // 0x07AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              NoForceTime;                                              // 0x07B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ForceTime;                                                // 0x07B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ForceGraceTime;                                           // 0x07B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MoveRightInput;                                           // 0x07BC(0x0004) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bClampVelocityToForward;                                  // 0x07C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x07C1(0x0003) MISSED OFFSET
	struct FVector                                     LocalRotationPivot;                                       // 0x07C4(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	bool                                               bUseDirectVelocity;                                       // 0x07D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x1F];                                      // 0x07D1(0x001F) MISSED OFFSET
	float                                              YawRotationAcceleration;                                  // 0x07F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MinYawRotationSpeed;                                      // 0x07F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxYawRotationSpeed;                                      // 0x07F8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x34];                                      // 0x07FC(0x0034) MISSED OFFSET
	bool                                               bUseNewAvoidance;                                         // 0x0830(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData06[0x1F];                                      // 0x0831(0x001F) MISSED OFFSET
...
public:
	...
	bool                                               bBattleRallyAlready;                                      // 0x0100(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x7];                                       // 0x0101(0x0007) MISSED OFFSET
	TArray<struct FS3BattleRallyInfo>                  BattleRallyInfoArray;                                     // 0x0108(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
public:
	...
	unsigned char                                      UnknownData01[0x23];                                      // 0x011D(0x0023) MISSED OFFSET
	TArray<int>                                        AddNewGameItem;                                           // 0x0140(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        RemoveNewGameItem;                                        // 0x0150(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        RemoveNewGameItemHakkason;                                // 0x0160(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        NoResetSubFlag;                                           // 0x0170(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<int>                                        ResetChobuMemo;                                           // 0x0180(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TMap<ES3Where, struct FS3SaveInitialParam>         InitialParamMap;                                          // 0x0190(0x0050) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FName>                               RemoveAcquisitionItemName;                                // 0x01E0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance)
	struct FS3SaveOverrideParam                        OverrideSaveParam;                                        // 0x01F0(0x0050)
	TArray<unsigned char>                              OutputSaveData;                                           // 0x0240(0x0010) (ZeroConstructor, Config)
	bool                                               bSystemDataLoaded;                                        // 0x0250(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bLoadingRetryData;                                        // 0x0251(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData02[0x6];                                       // 0x0252(0x0006) MISSED OFFSET
	class US3SaveGame*                                 LoadingData;                                              // 0x0258(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	TArray<class UObject*>                             LoadingDataAssets;                                        // 0x0260(0x0010) (ZeroConstructor, Transient, DuplicateTransient)
	TArray<class UClass*>                              LoadingDataClasses;                                       // 0x0270(0x0010) (ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData03[0x30];                                      // 0x0280(0x0030) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSystemDataLoaded;                                       // 0x02B0(0x0010) (Edit, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSaveLoadWidgetClosed;                                   // 0x02C0(0x0010) (Edit, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAutoSaveStarted;                                        // 0x02D0(0x0010) (Edit, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnAutoSaveFinished;                                       // 0x02E0(0x0010) (Edit, ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSystemSaveFinished;                                     // 0x02F0(0x0010) (Edit, ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	TArray<struct FS3BattleRallyInfo>                  BattleRallyInfoArray;                                     // 0x00C8(0x0010) (ZeroConstructor)
	TArray<int>                                        SystemFlagArray;                                          // 0x00D8(0x0010) (ZeroConstructor)
...
public:
	...
	class AS3SkyManager*                               SkyManager;                                               // 0x00F8(0x0008) (ZeroConstructor, IsPlainOldData)
	class US3GameInstance*                             S3GameInstance;                                           // 0x0100(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class US3TalkDataListBase*                         DataList;                                                 // 0x0148(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<struct FTalkScriptContainer>                FirstContactTalkScript;                                   // 0x0150(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      UnknownData00[0x10];                                      // 0x0160(0x0010) MISSED OFFSET
	TMap<float, bool>                                  EnableScheduleCache;                                      // 0x0170(0x0050) (Edit, BlueprintVisible, ZeroConstructor)
	TArray<struct FSetEnableScheduleData>              EnableScheduleData;                                       // 0x01C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               IsCheckSight;                                             // 0x01D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x01D1(0x0003) MISSED OFFSET
	float                                              PlayerToNPC_CanTalkAngle;                                 // 0x01D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bJawPointing;                                             // 0x01D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01D9(0x0003) MISSED OFFSET
	float                                              JawPointingYaw;                                           // 0x01DC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              JawPointingPitch;                                         // 0x01E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              JawPointingBlendTime;                                     // 0x01E4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bFingerPointing;                                          // 0x01E8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x01E9(0x0003) MISSED OFFSET
	float                                              FingerPointingYaw;                                        // 0x01EC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FingerPointingPitch;                                      // 0x01F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FingerPointingBlendTime;                                  // 0x01F4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	ES3FingerPointingMode                              FingerPointingMode;                                       // 0x01F8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
