...
bool ABP_S3BgmManager_C::Stop(struct FName* ID)
{
...
class AS3BgmPlayer* ABP_S3BgmManager_C::PlayFromCue(class UObject** Cue, struct FName* ID, EBgmPriority* Priority, bool* AutoDestroy, float* StartTime)
{
...
void ABP_S3BgmManager_C::PlayFromSequencer(class USoundAtomCue** Cue, struct FName* SoundId, float* StartTime, float* Volume, float* Pitch)
{
