...
struct FEventReply UWBP_DebugChangeClothes_C::OnKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
struct FEventReply UWBP_DebugChangeClothes_C::OnPreviewKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
