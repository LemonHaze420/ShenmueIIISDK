...
struct UBTT_PlayerFollow_AdjustSpeed_C_ReceiveTickAI_Params
{
...
struct UBTT_PlayerFollow_AdjustSpeed_C_ReceiveAbortAI_Params
{
	class AAIController**                              OwnerController;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class APawn**                                      ControlledPawn;                                           // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UBTT_PlayerFollow_AdjustSpeed_C_ExecuteUbergraph_BTT_PlayerFollow_AdjustSpeed_Params
{
