...
public:
	...
	TArray<struct FST_CutscenePlayInfo>                PlayInfoList;                                             // 0x03B8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class ABP_MoveCutsceneRoot_C*                      MoveCutsceneRoot;                                         // 0x03C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	class US3CutsceneLevelDataAsset*                   LevelDataAsset;                                           // 0x03D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsDisabledReplacePlayerFlag;                              // 0x03D8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               DebugIsDispSkeltalMeshInfo;                               // 0x03D9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               DebugIsUseAnotherShenfa;                                  // 0x03DA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x5];                                       // 0x03DB(0x0005) MISSED OFFSET
	class USkeletalMesh*                               DebugAnotherShenfaMesh;                                   // 0x03E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UWBP_DebugCutsceneID_C*                      DebugCutsceneIDWidget;                                    // 0x03E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	bool                                               IsStopGameTimeFlag;                                       // 0x03F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x03F1(0x0003) MISSED OFFSET
	struct FST_CutsceneFadeData                        CurrentFadeData;                                          // 0x03F4(0x0040) (Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                               IsShowLoadingScreenFlag;                                  // 0x0434(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsWaitingFinishLoadingScreenFlag;                         // 0x0435(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsWaitingLoadLevelAfterPlayerFinishedFlag;                // 0x0436(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x1];                                       // 0x0437(0x0001) MISSED OFFSET
	TMap<struct FName, struct FTransform>              LastCutsceneCharaReplaceTransformMap;                     // 0x0438(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	class US3CutsceneLevelData*                        CurrentCutsceneLevelData;                                 // 0x0488(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<EN_CutsceneManagerState>               CurrentState;                                             // 0x0490(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               DebugIsQTEForceSuccess;                                   // 0x0491(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsUseBattleLevelStreamingFlag;                            // 0x0492(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	TArray<struct FName> GetRequiredUnloadLevelList(struct FName* CutsceneId);
	...
	void SetupFadeData();
	bool StartCutscene(struct FName* CutsceneId, bool* UseFadeOut);
	bool IsUsingForceWeather();
	TArray<struct FName> GetRequiredLoadLevelList(struct FName* CutsceneId);
	bool IsExistLevelData(struct FName* CutsceneId);
