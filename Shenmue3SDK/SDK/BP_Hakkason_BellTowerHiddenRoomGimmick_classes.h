...
public:
	...
	void StartGimmickEvent(bool bForceFailed);
	...
	void ExecuteUbergraph_BP_Hakkason_BellTowerHiddenRoomGimmick(int EntryPoint);
	void OnEndItemSelect__DelegateSignature(bool bSuccess, int SelectItemNo);
	void OnEndGimmickEvent__DelegateSignature(bool bSuccess);
};
