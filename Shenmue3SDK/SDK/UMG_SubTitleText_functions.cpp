...
void UUMG_SubTitleText_C::SetText(struct FString* Body, struct FST_RubyInfo* InRubyInfo, struct FLinearColor* InSubtitleColor, struct FLinearColor* InOutlineColor)
{
