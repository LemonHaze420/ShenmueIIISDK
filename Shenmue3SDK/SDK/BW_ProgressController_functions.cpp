...
struct FEventReply UBW_ProgressController_C::OnAnalogValueChanged(struct FGeometry* MyGeometry, struct FAnalogInputEvent* InAnalogInputEvent)
{
...
void UBW_ProgressController_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
