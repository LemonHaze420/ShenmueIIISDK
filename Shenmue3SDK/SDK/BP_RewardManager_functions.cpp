...
// Function BP_RewardManager.BP_RewardManager_C.CreateItemDialogText
// (Private, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<struct FName>           Labels                         (Parm, OutParm, ZeroConstructor)

void ABP_RewardManager_C::CreateItemDialogText(TArray<struct FName>* Labels)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_RewardManager.BP_RewardManager_C.CreateItemDialogText");

	ABP_RewardManager_C_CreateItemDialogText_Params params;
