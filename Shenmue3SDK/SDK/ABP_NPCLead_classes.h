...
public:
	...
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_66FEABAC4716A83B03CB7D95E88EE1F3;// 0x0FF0(0x0050)
	struct FAnimNode_BlendListByBool                   AnimGraphNode_BlendListByBool_7F6F526D4C0FE51A90069C8865EB4A95;// 0x1040(0x00D0)
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_DDEA70634FB23D19CE38359DF75CC737;// 0x1110(0x0050)
	struct FAnimNode_SaveCachedPose                    AnimGraphNode_SaveCachedPose_597F174E43E638FC531263BDD201FE4E;// 0x1160(0x00E0)
	struct FAnimNode_ConvertLocalToComponentSpace      AnimGraphNode_LocalToComponentSpace_D727C2BA49A50DB3AA78958AB724DA30;// 0x1240(0x0048)
	struct FAnimNode_ConvertComponentToLocalSpace      AnimGraphNode_ComponentToLocalSpace_17A3A10E4EA02D0C0C2A5E8035ED0CE0;// 0x1288(0x0048)
	struct FAnimNode_S3TwoBoneIK                       AnimGraphNode_S3TwoBoneIK_8E1E821842B8E73ED279E58A2706232D;// 0x12D0(0x01B0)
	struct FAnimNode_SaveCachedPose                    AnimGraphNode_SaveCachedPose_02B2CD0E4CB18DF60570F9A30B04C09A;// 0x1480(0x00E0)
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_13AC89A14707D07614C31EA08084C908;// 0x1560(0x0050)
	struct FAnimNode_UseCachedPose                     AnimGraphNode_UseCachedPose_AE1FE1A34C2E4CF22E5184848B5A89D7;// 0x15B0(0x0050)
	struct FAnimNode_TwoWayBlend                       AnimGraphNode_TwoWayBlend_C22B52BC477C62526DC76BB0CCE767F5;// 0x1600(0x0120)
	float                                              RateKI;                                                   // 0x1720(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RateDO;                                                   // 0x1724(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RateAI;                                                   // 0x1728(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RateRAKU;                                                 // 0x172C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<bool>                                       IsEyeRotateEmotionFlags;                                  // 0x1730(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	float                                              TurnAroundAngle;                                          // 0x1740(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                TurnAroundAnimStep;                                       // 0x1744(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              VelocityLength;                                           // 0x1748(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FVector                                     ForwardDirection;                                         // 0x174C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	float                                              StrideScale;                                              // 0x1758(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              SpeedWarpingAlpha;                                        // 0x175C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               ABP_EnableTalkTurnRootMotion;                             // 0x1760(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x1761(0x0003) MISSED OFFSET
	float                                              WalkMotionMinSpeed;                                       // 0x1764(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MinStrideRatio;                                           // 0x1768(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               IsTalking;                                                // 0x176C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x176D(0x0003) MISSED OFFSET
	class ABP_NPC_Lead_C*                              LeadCharacter;                                            // 0x1770(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	class UBP_S3AnimNotifyComponent_C*                 NotifyComponent;                                          // 0x1778(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	float                                              LegGroundIKAlpha;                                         // 0x1780(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              LeftLegLandingWeight;                                     // 0x1784(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              RightLegLandingWeight;                                    // 0x1788(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bEnablelegIK;                                             // 0x178C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bTeleportReset;                                           // 0x178D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x2];                                       // 0x178E(0x0002) MISSED OFFSET
	float                                              SlopeAngle;                                               // 0x1790(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               InIdle;                                                   // 0x1794(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x3];                                       // 0x1795(0x0003) MISSED OFFSET
	class UBlendSpaceBase*                             BS_TalkTurn;                                              // 0x1798(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void EvaluateGraphExposedInputs_ExecuteUbergraph_ABP_NPCLead_AnimGraphNode_BlendListByBool_7F6F526D4C0FE51A90069C8865EB4A95();
