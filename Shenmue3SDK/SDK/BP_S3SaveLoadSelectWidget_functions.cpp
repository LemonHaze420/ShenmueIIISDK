...
struct FEventReply UBP_S3SaveLoadSelectWidget_C::OnKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
void UBP_S3SaveLoadSelectWidget_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
