...
void ABP_SearchArea_C::SetPlayLabelType(ES3TextPathType PlayLabelType)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_SearchArea.BP_SearchArea_C.SetPlayLabelType");

	ABP_SearchArea_C_SetPlayLabelType_Params params;
	params.PlayLabelType = PlayLabelType;
...
void ABP_SearchArea_C::SetLockonTarget(class US3SearchComponent* Search)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_SearchArea.BP_SearchArea_C.SetLockonTarget");

	ABP_SearchArea_C_SetLockonTarget_Params params;
	params.Search = Search;
...
void ABP_SearchArea_C::PlayCutscene(struct FName* CutsceneId)
{
...
void ABP_SearchArea_C::GetItem(struct FName* ItemId)
{
