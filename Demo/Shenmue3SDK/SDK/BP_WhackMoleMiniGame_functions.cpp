...
void ABP_WhackMoleMiniGame_C::ResumeMiniGame(struct FString* ResumeKeyword)
{
...
void ABP_WhackMoleMiniGame_C::ChangedClothes(TScriptInterface<class US3ClothInterface>* Interface, struct FName* CharaName)
{
