...
void ABP_SoundManager_C::PlayFromSequencer(class USoundAtomCue** Cue, struct FName* SoundId, ESequenceSelectorType* Selector, bool* bOneShot, float* StartTime, float* Volume, float* Pitch)
{
