...
#define GOBJECTS_OFFSET_V100		0x32CF338
#define GOBJECTS_OFFSET_V101		0x32CF3B8

#define GNAMES_OFFSET_V100			0x32C66A0
#define GNAMES_OFFSET_V101			0x32C6720

#define UE4_VERSTRING_V100			0x22FB700
#define UE4_VERSTRING_V101			0x22FC500

#define WIN32_LEAN_AND_MEAN         // Exclude rarely-used stuff from Windows headers
#define _CRT_SECURE_NO_WARNINGS		// Disable warnings when using non-safe mem funcs
...
namespace SDK
{
	...
	*/
	...
	static DWORD		g_Size;
	std::vector<ProcessEventUserHook> g_ProcessEventUserHooks;
