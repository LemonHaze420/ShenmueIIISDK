...
struct FEventReply Uwgt_TalkCameraPrev_C::OnKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
struct FEventReply Uwgt_TalkCameraPrev_C::OnPreviewKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
void Uwgt_TalkCameraPrev_C::Tick(struct FGeometry* MyGeometry, float* InDeltaTime)
{
