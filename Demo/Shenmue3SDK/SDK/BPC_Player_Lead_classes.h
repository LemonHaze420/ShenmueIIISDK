...
public:
	...
	TArray<class ABP_NoFollowRegion_C*>                NoFollowRegions;                                          // 0x0108(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance)
