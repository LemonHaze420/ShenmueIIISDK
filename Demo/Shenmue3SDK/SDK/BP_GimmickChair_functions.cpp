...
float ABP_GimmickChair_C::GetNearStartPointDist(struct FTransform* Point, int* poiIdx, int* stIdx)
{
...
bool ABP_GimmickChair_C::ModeChangeRequest(EChairOccupied* Mode, class AS3Character** Character, struct FVector* pos, int* poiIdx, int* stIdx, float* moveDist, struct FS3ChairResultStruct* Result)
{
