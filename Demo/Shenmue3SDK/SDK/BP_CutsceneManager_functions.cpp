...
TArray<struct FName> ABP_CutsceneManager_C::GetRequiredUnloadLevelList(struct FName* CutsceneId)
{
...
bool ABP_CutsceneManager_C::StartCutscene(struct FName* CutsceneId, bool* UseFadeOut)
{
...
TArray<struct FName> ABP_CutsceneManager_C::GetRequiredLoadLevelList(struct FName* CutsceneId)
{
...
bool ABP_CutsceneManager_C::IsExistLevelData(struct FName* CutsceneId)
{
