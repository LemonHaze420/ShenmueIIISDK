...
{
public:
	TArray<class UBehaviorTree*>                       LoadedTrees;                                              // 0x0150(0x0010) (ZeroConstructor)
	TArray<class UBTCompositeNode*>                    LoadedRootNodes;                                          // 0x0160(0x0010) (ZeroConstructor)
	...
	unsigned char                                      UnknownData01[0x120];                                     // 0x01A0(0x0120) MISSED OFFSET
