...
struct ABP_OtoshiDama_Input2_C_InpAxisEvt_MG_LeftStickVertical_K2Node_InputAxisEvent_3_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_OtoshiDama_Input2.BP_OtoshiDama_Input2_C.ExecuteUbergraph_BP_OtoshiDama_Input2
struct ABP_OtoshiDama_Input2_C_ExecuteUbergraph_BP_OtoshiDama_Input2_Params
{
