...
void ABP_AnimalRaceBase_C::ResumeMiniGame(struct FString* ResumeKeyword)
{
...
// Function BP_AnimalRaceBase.BP_AnimalRaceBase_C.EventCountChange
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// int                            Count                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_AnimalRaceBase_C::EventCountChange(int Count)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_AnimalRaceBase.BP_AnimalRaceBase_C.EventCountChange");

	ABP_AnimalRaceBase_C_EventCountChange_Params params;
	params.Count = Count;
