...
public:
	...
	class AS3BgmPlayer* PlayFromCue(class UObject** Cue, struct FName* ID, EBgmPriority* Priority, bool* AutoDestroy, float* StartTime);
	...
	void Pause();
	void Restart();
	void PlayFromSequencer(class USoundAtomCue** Cue, struct FName* SoundId, float* StartTime, float* Volume, float* Pitch);
