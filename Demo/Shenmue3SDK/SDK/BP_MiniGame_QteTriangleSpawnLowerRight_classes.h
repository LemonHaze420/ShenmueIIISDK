...
// BlueprintGeneratedClass BP_MiniGame_QteTriangleSpawnLowerRight.BP_MiniGame_QteTriangleSpawnLowerRight_C
// 0x0064 (0x038C - 0x0328)
class ABP_MiniGame_QteTriangleSpawnLowerRight_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MiniGame_QteTriangleSpawnLowerRight.BP_MiniGame_QteTriangleSpawnLowerRight_C");
		return ptr;
	}
