...
public:
	...
	class UBP_GamePadFaceButtonSetAsset_C*             DPad_Default;                                             // 0x0060(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBP_GamePadFaceButtonSetAsset_C*             Face_Blank;                                               // 0x0068(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBP_GamePadFaceButtonSetAsset_C*             Face_PopBack;                                             // 0x0070(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UBP_GamePadShoulderSetAsset_C*               Shoulder_Default;                                         // 0x0078(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBP_GamePadShoulderSetAsset_C*               Shoulder_Brush;                                           // 0x0080(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBP_GamePadShoulderSetAsset_C*               Shoulder_BrushBorder;                                     // 0x0088(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBP_GamePadFaceButtonSetAsset_C*             Face_QTECommand;                                          // 0x0090(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
