...
struct ABP_MiniGame_QteTriangleSpawnLowerRight_C_SetVisible_Params
{
	bool                                               Condition;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_MiniGame_QteTriangleSpawnLowerRight.BP_MiniGame_QteTriangleSpawnLowerRight_C.RemoveTriangle
struct ABP_MiniGame_QteTriangleSpawnLowerRight_C_RemoveTriangle_Params
{
...
struct ABP_MiniGame_QteTriangleSpawnLowerRight_C_ExecuteUbergraph_BP_MiniGame_QteTriangleSpawnLowerRight_Params
{
