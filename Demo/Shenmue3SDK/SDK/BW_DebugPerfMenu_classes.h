...
// WidgetBlueprintGeneratedClass BW_DebugPerfMenu.BW_DebugPerfMenu_C
// 0x0010 (0x0218 - 0x0208)
class UBW_DebugPerfMenu_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BW_DebugPerfMenu.BW_DebugPerfMenu_C");
		return ptr;
	}
