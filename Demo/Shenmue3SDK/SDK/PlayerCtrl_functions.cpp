...
void APlayerCtrl_C::PC_ShouldDelayTalkInteract(bool* bCanStop)
{
...
void APlayerCtrl_C::InpActEvt_Gamepad_FaceButton_Bottom_K2Node_InputKeyEvent_4(const struct FKey& Key)
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerCtrl.PlayerCtrl_C.InpActEvt_Gamepad_FaceButton_Bottom_K2Node_InputKeyEvent_4");

	APlayerCtrl_C_InpActEvt_Gamepad_FaceButton_Bottom_K2Node_InputKeyEvent_4_Params params;
	params.Key = Key;
...
void APlayerCtrl_C::InpActEvt_Gamepad_FaceButton_Bottom_K2Node_InputKeyEvent_3(const struct FKey& Key)
{
	static auto fn = UObject::FindObject<UFunction>("Function PlayerCtrl.PlayerCtrl_C.InpActEvt_Gamepad_FaceButton_Bottom_K2Node_InputKeyEvent_3");

	APlayerCtrl_C_InpActEvt_Gamepad_FaceButton_Bottom_K2Node_InputKeyEvent_3_Params params;
	params.Key = Key;
