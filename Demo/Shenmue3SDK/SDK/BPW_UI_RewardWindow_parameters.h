...
struct UBPW_UI_RewardWindow_C_GetLabel_Params
{
...
struct UBPW_UI_RewardWindow_C_Construct_Params
{
};
...
struct UBPW_UI_RewardWindow_C_BndEvt__NewAnimation_1_K2Node_ComponentBoundEvent_0_OnWidgetAnimationPlaybackStatusChanged__DelegateSignature_Params
{
};

// Function BPW_UI_RewardWindow.BPW_UI_RewardWindow_C.ExecuteUbergraph_BPW_UI_RewardWindow
struct UBPW_UI_RewardWindow_C_ExecuteUbergraph_BPW_UI_RewardWindow_Params
{
	int                                                EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BPW_UI_RewardWindow.BPW_UI_RewardWindow_C.ED_FinishAnim__DelegateSignature
struct UBPW_UI_RewardWindow_C_ED_FinishAnim__DelegateSignature_Params
{
};
