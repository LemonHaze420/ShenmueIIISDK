...
public:
	...
	struct FText STATIC_FormatMoneyText_dispWidget(int Value, int Min, int Max, class UObject* __WorldContext);
	...
	void STATIC_SetMoneyStatus_dispWidget(class UTextBlock* BetMoney, class UTextBlock* Money, class UTextBlock* Meter, class UTextBlock* HeelDrink, class UObject* __WorldContext);
};
