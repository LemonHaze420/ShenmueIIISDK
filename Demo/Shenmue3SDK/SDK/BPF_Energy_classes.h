...
public:
	...
	void STATIC_BPF_GetPlayerEnergyRegenMax_Ratio_(class UObject* __WorldContext, float* OutEnergy);
	...
	void STATIC_BPF_SetPlayerEnergy_Ratio_(float Ratio, class UObject* __WorldContext);
	void STATIC_BPF_SetPlayerEnergy_Points_(float Amount, class UObject* __WorldContext);
	float STATIC_BPF_GetPlayerEnergyMultiplier(class UObject* __WorldContext);
	bool STATIC_BPF_IsEnergySystemValid(class UObject* __WorldContext);
	void STATIC_BPF_GetPlayerEnergyRegenRate(class UObject* __WorldContext);
	...
	void STATIC_BPF_SetPlayerEnergyToMax(class UObject* __WorldContext);
	void STATIC_BPF_GetPlayerEnergyRange_Ratio_(class UObject* __WorldContext, struct FVector2D* Range);
	...
	void STATIC_BPF_AddPlayerEnergy_float_(float Amt, class UObject* __WorldContext);
	...
	void STATIC_BPF_AddPlayerEnergy_Int_(int Amt, class UObject* __WorldContext);
