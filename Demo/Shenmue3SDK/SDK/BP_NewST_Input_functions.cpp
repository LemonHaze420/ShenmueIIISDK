...
// Function BP_NewST_Input.BP_NewST_Input_C.InpActEvt_MG_Top_K2Node_InputActionEvent_6
// (BlueprintEvent)
// Parameters:
// struct FKey                    Key                            (BlueprintVisible, BlueprintReadOnly, Parm)

void ABP_NewST_Input_C::InpActEvt_MG_Top_K2Node_InputActionEvent_6(const struct FKey& Key)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_NewST_Input.BP_NewST_Input_C.InpActEvt_MG_Top_K2Node_InputActionEvent_6");

	ABP_NewST_Input_C_InpActEvt_MG_Top_K2Node_InputActionEvent_6_Params params;
	params.Key = Key;
...
// Function BP_NewST_Input.BP_NewST_Input_C.InpActEvt_MG_Bottom_K2Node_InputActionEvent_5
// (BlueprintEvent)
// Parameters:
// struct FKey                    Key                            (BlueprintVisible, BlueprintReadOnly, Parm)

void ABP_NewST_Input_C::InpActEvt_MG_Bottom_K2Node_InputActionEvent_5(const struct FKey& Key)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_NewST_Input.BP_NewST_Input_C.InpActEvt_MG_Bottom_K2Node_InputActionEvent_5");

	ABP_NewST_Input_C_InpActEvt_MG_Bottom_K2Node_InputActionEvent_5_Params params;
	params.Key = Key;
...
// Function BP_NewST_Input.BP_NewST_Input_C.InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_4
// (BlueprintEvent)
// Parameters:
// struct FKey                    Key                            (BlueprintVisible, BlueprintReadOnly, Parm)

void ABP_NewST_Input_C::InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_4(const struct FKey& Key)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_NewST_Input.BP_NewST_Input_C.InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_4");

	ABP_NewST_Input_C_InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_4_Params params;
	params.Key = Key;
