...
// Function BP_Minigame_Fishing_Test.BP_Minigame_Fishing_Test_C.CheckIsFirstPlay
// (Public, HasOutParms, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           IsFirst                        (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void ABP_Minigame_Fishing_Test_C::CheckIsFirstPlay(bool* IsFirst)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Minigame_Fishing_Test.BP_Minigame_Fishing_Test_C.CheckIsFirstPlay");

	ABP_Minigame_Fishing_Test_C_CheckIsFirstPlay_Params params;
