...
bool ABP_Clipper_C::SetCharaName(struct FName* NewName)
{
...
bool ABP_Clipper_C::SetTalkClipperInternal(struct FString* TalkClipperString, struct FName* CharaName, bool* bVoice, class AS3SoundPlayer** VoicePlayer)
{
