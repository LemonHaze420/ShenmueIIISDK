...
// WidgetBlueprintGeneratedClass BPW_UI_DressMode_Button.BPW_UI_DressMode_Button_C
// 0x0011 (0x0219 - 0x0208)
class UBPW_UI_DressMode_Button_C : public UUserWidget
{
public:
	...
	TEnumAsByte<EN_DressMode_SelectMode>               Mode;                                                     // 0x0218(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BPW_UI_DressMode_Button.BPW_UI_DressMode_Button_C");
		return ptr;
	}
