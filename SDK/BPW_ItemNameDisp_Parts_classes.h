...
// WidgetBlueprintGeneratedClass BPW_ItemNameDisp_Parts.BPW_ItemNameDisp_Parts_C
// 0x0010 (0x0218 - 0x0208)
class UBPW_ItemNameDisp_Parts_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BPW_ItemNameDisp_Parts.BPW_ItemNameDisp_Parts_C");
		return ptr;
	}
