...
public:
	...
	float                                              MinCapsuleRadius;                                         // 0x0758(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bShrinkCapsule;                                           // 0x075C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// Class BattleLabo.BTL_BRallyRacerAnimData
// 0x00A0 (0x00D0 - 0x0030)
class UBTL_BRallyRacerAnimData : public UDataAsset
{
public:
	struct FBTL_BRallyCourseCutsceneData               IntroCutscene;                                            // 0x0030(0x0020) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FBTL_BRallyCourseCutsceneData               IntroCutsceneB;                                           // 0x0050(0x0020) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FBTL_BRallyCourseCutsceneData               RetireCutscene;                                           // 0x0070(0x0020) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FBTL_BRallyCourseCutsceneData               GoalCutscene;                                             // 0x0090(0x0020) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)
	struct FBTL_BRallyCourseCutsceneData               ClearCutscene;                                            // 0x00B0(0x0020) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class BattleLabo.BTL_BRallyRacerAnimData");
		return ptr;
	}


	bool SelectIntroCutscene(int PlayNum, bool bAllowB, struct FBTL_BRallyCourseCutsceneData* OutData);
};
...
// Class BattleLabo.BTL_BRallyScoreKeeper
// 0x0088 (0x0178 - 0x00F0)
class UBTL_BRallyScoreKeeper : public UActorComponent
{
public:
	TArray<struct FBTL_ScoreTallyData>                 TallyScores;                                              // 0x00F0(0x0010) (ZeroConstructor, Transient)
	TMap<struct FName, struct FBTL_ScoreGroupData>     MaxCounts;                                                // 0x0100(0x0050) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0150(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnTotalScoreIncreased;                                    // 0x0158(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnTotalScoreChanged;                                      // 0x0168(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class BattleLabo.BTL_BRallyScoreKeeper");
		return ptr;
	}


	void SortResults(class UDataTable* DataTable);
	int GetTotalScore();
	TArray<struct FBTL_ScoreTallyData> GetResults();
	void Clear();
	void AddToMaxCounts(TArray<struct FDataTableRowHandle> DataTableRowHandles);
	void AddPointsFromTableRows(TArray<struct FDataTableRowHandle> DataTableRowHandles);
	void AddPointsFromTableRow(const struct FDataTableRowHandle& DataTableRowHandle, int Times);
	void AddPointsByRatio(const struct FDataTableRowHandle& DataTableRowHandle, float Ratio);
};
...
{
public:
	unsigned char                                      UnknownData00[0x11];                                      // 0x0770(0x0011) MISSED OFFSET
	bool                                               bEnablePathFollowerDirectMove;                            // 0x0781(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x0782(0x0002) MISSED OFFSET
	struct FVector                                     PathFollowerDirectMoveVector;                             // 0x0784(0x000C) (BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	bool                                               bPathFollowerRequestMaxSpeed;                             // 0x0790(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xF];                                       // 0x0791(0x000F) MISSED OFFSET
	...
	void SetEnableStepUp(bool bValue);
...
public:
	...
	struct FName                                       FirstPlaceAward;                                          // 0x0038(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       RequiredAward;                                            // 0x0040(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       StartLocationLabel;                                       // 0x0048(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FName                                       EndLocationLabel;                                         // 0x0050(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UBTL_CourseMapData*                          MapData;                                                  // 0x0058(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UDataTable*                                  NPCRecords;                                               // 0x0060(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                TimeScoreMultiplier;                                      // 0x0068(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x006C(0x0004) MISSED OFFSET
	TArray<class UBTL_CourseEventData*>                Events;                                                   // 0x0070(0x0010) (Edit, BlueprintVisible, ExportObject, ZeroConstructor)
...
public:
	...
	bool                                               bEnableIntroB;                                            // 0x0044(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	void TrimToNum(int MaxNum);
	void ReadSaveData(const struct FBTL_CourseSaveData& SaveData);
	struct FBTL_CourseSaveData MakeSaveData(TArray<struct FName> PlayerIds);
	...
	int GetRankPlaceAtIndex(int Index);
	int GetRankPlace(const struct FName& CharacterID);
	int GetRankIndex(const struct FName& CharacterID);
	struct FName GetParCharacter();
	struct FName GetCourseId();
	void EnableDuplicates(bool bValue);
	bool CompareToParRecord(const struct FBTL_LeaderboardRecord& Record, int* Relative);
	bool CompareRankToPar(const struct FName& InCharacter, int* RanksAbove);
	int AddRecord(const struct FBTL_LeaderboardRecord& NewEntry);
};


// Class BattleLabo.BTL_CourseMapData
// 0x0018 (0x0040 - 0x0028)
class UBTL_CourseMapData : public UObject
{
public:
	class UTexture2D*                                  MapTexture;                                               // 0x0028(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   StartLabelLocation;                                       // 0x0030(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FVector2D                                   GoalLabelLocation;                                        // 0x0038(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("Class BattleLabo.BTL_CourseMapData");
		return ptr;
	}


	bool AreLabelLocationsValid();
};
...
public:
	...
	void ResetReflectTransformCache();
...
public:
	...
	struct FName                                       Requirement;                                              // 0x0038(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UBTL_PlayerCharacterDataAsset*               BattleAsset;                                              // 0x0040(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0048(0x0028) UNKNOWN PROPERTY: SoftObjectProperty BattleLabo.BTL_RacerDataAsset.AnimationData
	TArray<struct FName>                               ShortcutSkills;                                           // 0x0070(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	struct FBTL_RacerStatLimits                        Attack;                                                   // 0x0080(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	struct FBTL_RacerStatLimits                        Vitality;                                                 // 0x0088(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, IsPlainOldData)
	class UTexture2D*                                  PortraitTexture;                                          // 0x0090(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
