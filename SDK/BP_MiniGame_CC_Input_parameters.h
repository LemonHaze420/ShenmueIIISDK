...
struct ABP_MiniGame_CC_Input_C_InpAxisEvt_MG_LeftStickHorizontal_K2Node_InputAxisEvent_21_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_MiniGame_CC_Input.BP_MiniGame_CC_Input_C.InpAxisEvt_MG_RightStickHorizontal_K2Node_InputAxisEvent_34
struct ABP_MiniGame_CC_Input_C_InpAxisEvt_MG_RightStickHorizontal_K2Node_InputAxisEvent_34_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_MiniGame_CC_Input.BP_MiniGame_CC_Input_C.ReceiveTick
struct ABP_MiniGame_CC_Input_C_ReceiveTick_Params
{
	float                                              DeltaSeconds;                                             // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_MiniGame_CC_Input.BP_MiniGame_CC_Input_C.ExecuteUbergraph_BP_MiniGame_CC_Input
struct ABP_MiniGame_CC_Input_C_ExecuteUbergraph_BP_MiniGame_CC_Input_Params
{
