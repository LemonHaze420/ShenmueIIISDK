...
public:
	...
	bool                                               bPersistAcrossLevelTransition;                            // 0x0244(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0245(0x0003) MISSED OFFSET
	unsigned char                                      bStopWhenOwnerDestroyed : 1;                              // 0x0248(0x0001)
	unsigned char                                      bIsUISound : 1;                                           // 0x0248(0x0001)
	unsigned char                                      UnknownData02[0x7];                                       // 0x0249(0x0007) MISSED OFFSET
	float                                              DefaultVolume;                                            // 0x0250(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bEnableMultipleSoundPlayback;                             // 0x0254(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	bool                                               bUsePlaylist;                                             // 0x0255(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x2];                                       // 0x0256(0x0002) MISSED OFFSET
	class UAtomSoundObject*                            DefaultSoundObject;                                       // 0x0258(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                DefaultBlockIndex;                                        // 0x0260(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x4];                                       // 0x0264(0x0004) MISSED OFFSET
	TArray<struct FAtomAisacControlParam>              DefaultAisacControl;                                      // 0x0268(0x0010) (Edit, ZeroConstructor)
	TArray<struct FAtomSelectorParam>                  DefaultSelectorLabel;                                     // 0x0278(0x0010) (Edit, ZeroConstructor)
	struct FScriptMulticastDelegate                    OnAudioFinished;                                          // 0x0288(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	class UWorld*                                      PlayWorld;                                                // 0x0298(0x0008) (ZeroConstructor, IsPlainOldData)
	class UGameViewportClient*                         GameViewport;                                             // 0x02A0(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData06[0x7];                                       // 0x02C1(0x0007) MISSED OFFSET
	class USoundAttenuation*                           AttenuationSettings;                                      // 0x02C8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FSoundAttenuationSettings                   AttenuationOverrides;                                     // 0x02D0(0x02A8) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData07[0x928];                                     // 0x0578(0x0928) MISSED OFFSET
...
public:
	...
	class UCriFsBinderComponent*                       BinderComponent;                                          // 0x0250(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	...
	class USoundAtomCueSheet*                          CueSheet;                                                 // 0x02A8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    OnBindCompleted;                                          // 0x0248(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnBindError;                                              // 0x0258(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0x28];                                      // 0x0268(0x0028) MISSED OFFSET
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0240(0x0008) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnLoadCompleted;                                          // 0x0248(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnLoadError;                                              // 0x0258(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	struct FScriptMulticastDelegate                    OnEventPoint;                                             // 0x00F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnSubtitleChanged;                                        // 0x0108(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptMulticastDelegate                    OnStatusChanged;                                          // 0x0118(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	struct FScriptDelegate                             OnRequestData;                                            // 0x0128(0x0014) (BlueprintVisible, ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0x40];                                      // 0x0138(0x0040) MISSED OFFSET
	class UManaPlaylist*                               Playlist;                                                 // 0x0178(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	int                                                PlaylistIndex;                                            // 0x0180(0x0004) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	bool                                               bLoop;                                                    // 0x0184(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0185(0x0003) MISSED OFFSET
	int                                                AudioTrack;                                               // 0x0188(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                SubAudioTrack;                                            // 0x018C(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                ExtraAudioTrack;                                          // 0x0190(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bSubtitlesEnabled;                                        // 0x0194(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x0195(0x0003) MISSED OFFSET
	int                                                SubtitlesChannel;                                         // 0x0198(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EManaSubtitlesEncoding                             SubtitlesEncoding;                                        // 0x019C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EManaFrameAction                                   EndFrameAction;                                           // 0x019D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EManaPlaybackTimer                                 PlaybackTimer;                                            // 0x019E(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData03[0x81];                                      // 0x019F(0x0081) MISSED OFFSET
