...
void ABP_MiniGameBase_C::UnBindEventToSequenceFinished(const struct FScriptDelegate& 񍯐�0�0)
{
...
void ABP_MiniGameBase_C::BindEventToSequenceFinished(class ULevelSequencePlayer* SequencePlayer, const struct FScriptDelegate& 񍯐�0�0)
{
