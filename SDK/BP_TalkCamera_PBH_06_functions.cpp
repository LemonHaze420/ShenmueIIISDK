...
void ABP_TalkCamera_PBH_06_C::STATIC_UserConstructionScript()
{
...
// (Net, NetReliable, Exec, Native, NetResponse, Static, NetMulticast, Private, NetServer, HasDefaults, NetClient, DLLImport, BlueprintEvent, BlueprintPure)

void ABP_TalkCamera_PBH_06_C::STATIC_ReceiveBeginPlay()
{
...
// (Net, NetRequest, Exec, Native, Public, Private, NetClient, BlueprintCallable, BlueprintPure, Const)
// Parameters:
...
// (Net, Exec, Native, Event, Public, Private, Delegate, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
