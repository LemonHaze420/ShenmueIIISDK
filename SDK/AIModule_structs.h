...
{
	TWeakObjectPtr<class UBehaviorTree>                Asset;                                                    // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UBTCompositeNode>             Template;                                                 // 0x0008(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
