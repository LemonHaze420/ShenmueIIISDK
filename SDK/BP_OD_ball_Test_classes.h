...
public:
	...
	unsigned char                                      UnknownData06[0x2];                                       // 0x03CA(0x0002) MISSED OFFSET
	struct FVector                                     StopLocation;                                             // 0x03CC(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	float                                              STOP_CHECK_TIME;                                          // 0x03D8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
