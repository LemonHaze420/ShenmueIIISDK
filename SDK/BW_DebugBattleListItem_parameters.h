...
struct UBW_DebugBattleListItem_C_SetFocusToButton_Params
{
};

// Function BW_DebugBattleListItem.BW_DebugBattleListItem_C.Construct
struct UBW_DebugBattleListItem_C_Construct_Params
{
};
...
struct UBW_DebugBattleListItem_C_BndEvt__ItemButton_K2Node_ComponentBoundEvent_40_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function BW_DebugBattleListItem.BW_DebugBattleListItem_C.OnAddedToFocusPath
struct UBW_DebugBattleListItem_C_OnAddedToFocusPath_Params
{
	struct FFocusEvent                                 InFocusEvent;                                             // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function BW_DebugBattleListItem.BW_DebugBattleListItem_C.ExecuteUbergraph_BW_DebugBattleListItem
struct UBW_DebugBattleListItem_C_ExecuteUbergraph_BW_DebugBattleListItem_Params
{
	int                                                EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BW_DebugBattleListItem.BW_DebugBattleListItem_C.OnFocused__DelegateSignature
struct UBW_DebugBattleListItem_C_OnFocused__DelegateSignature_Params
{
...
struct UBW_DebugBattleListItem_C_OnStartBattle__DelegateSignature_Params
{
};
