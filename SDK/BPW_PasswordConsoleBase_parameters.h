...
struct UBPW_PasswordConsoleBase_C_SetInPasswordEdit_Params
{
...
struct UBPW_PasswordConsoleBase_C_GetPasswordAsLabel_Params
{
	struct FName                                       ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function BPW_PasswordConsoleBase.BPW_PasswordConsoleBase_C.SetWidgetText
struct UBPW_PasswordConsoleBase_C_SetWidgetText_Params
{
...
struct UBPW_PasswordConsoleBase_C_SetInitialText_Params
{
};
