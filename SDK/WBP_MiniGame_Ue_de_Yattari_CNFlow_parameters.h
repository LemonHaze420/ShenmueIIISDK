...
struct UWBP_MiniGame_Ue_de_Yattari_CNFlow_C_SetEffectImageTexture_Params
{
...
struct UWBP_MiniGame_Ue_de_Yattari_CNFlow_C_SetBackImageTexture_Params
{
	class UTexture2D*                                  Texture;                                                  // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function WBP_MiniGame_Ue_de_Yattari_CNFlow.WBP_MiniGame_Ue_de_Yattari_CNFlow_C.PlayShowResult
struct UWBP_MiniGame_Ue_de_Yattari_CNFlow_C_PlayShowResult_Params
{
...
struct UWBP_MiniGame_Ue_de_Yattari_CNFlow_C_ExecuteUbergraph_WBP_MiniGame_Ue_de_Yattari_CNFlow_Params
{
