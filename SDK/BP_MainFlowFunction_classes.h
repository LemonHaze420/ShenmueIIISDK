...
public:
	...
	void STATIC_TrgEvent_Exec(bool* rc);
	void STATIC_TrgEvent_Enable(class UPrimitiveComponent* TriggerCompo_Name, const struct FName& EventName, int ControlStatus, TEnumAsByte<EN_MainFlowEventType> EventType, const struct FString& UniqueParameta);
	void STATIC_TrgEvent_Manager();
	void STATIC_CallTrgEvent();
