...
struct UBPC_SplineMovementTalkActorCamera_C_SplineMovingProcess_Params
{
	bool                                               Result;                                                   // (Parm, OutParm, ZeroConstructor, IsPlainOldData)
};

// Function BPC_SplineMovementTalkActorCamera.BPC_SplineMovementTalkActorCamera_C.ReceiveBeginPlay
struct UBPC_SplineMovementTalkActorCamera_C_ReceiveBeginPlay_Params
{
};

// Function BPC_SplineMovementTalkActorCamera.BPC_SplineMovementTalkActorCamera_C.ForceMoveSpline
struct UBPC_SplineMovementTalkActorCamera_C_ForceMoveSpline_Params
{
};
...
struct UBPC_SplineMovementTalkActorCamera_C_ExecuteUbergraph_BPC_SplineMovementTalkActorCamera_Params
{
