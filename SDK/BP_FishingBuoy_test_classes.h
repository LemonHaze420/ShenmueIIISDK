...
public:
	...
	void STATIC_SetRefractionRate(float Rate);
	void STATIC_InitializeBuoyTransform(const struct FVector& PreBuoyLocation, const struct FVector& BaseDirection);
	void STATIC_SetPreBuoyLocation(const struct FVector& PreBuoyLocation);
	void STATIC_UpdateBuoyTransform(bool ForceUpdate);
	void STATIC_GetCableLengthRate(float* CableLengthRate);
	void STATIC_ResetIdleMove();
	void STATIC_UpdateIdleMove();
	void UpdatePull();
	void STATIC_AddPower(const struct FVector& ArgVector, float ArgPow);
	void GetBPMinigameFishing(class ABP_Minigame_Fishing_Test_C** RetBPFishing);
	void ProjectileStopFunc();
	void STATIC_UpdateGuideArrowMove();
	void STATIC_SetupGuideArrow(class ABP_Fishing_Arrow_C* ArgArrow, float ArgArrowPow);
	void STATIC_UpdateDelayHoming();
	void STATIC_ResetHoming();
	...
	void STATIC_Small_UpDown__FinishedFunc();
	void STATIC_Small_UpDown__UpdateFunc();
	void STATIC_Big_UpDown__FinishedFunc();
	void STATIC_Big_UpDown__UpdateFunc();
	void STATIC_BouyMoveTimeline__FinishedFunc();
	void STATIC_BouyMoveTimeline__UpdateFunc();
	void STATIC_BndEvt__ProjectileMovement_K2Node_ComponentBoundEvent_1_OnProjectileStopDelegate__DelegateSignature(const struct FHitResult& ImpactResult);
	void STATIC_Stop_Small_UpDown();
	void STATIC_Start_Big_UpDown();
	void STATIC_Stop_Big_UpDown();
	void STATIC_Set_Active(bool is_active);
	void SetLureMesh(class UStaticMesh* Mesh, float Scale);
	void STATIC_ReceiveEndPlay(TEnumAsByte<EEndPlayReason> EndPlayReason);
	void STATIC_Start_Small_UpDown();
	void STATIC_SetActiveBuoyVelocityDir(bool Active);
	void STATIC_StopBuoyVelocityMove();
	void STATIC_PlayBuoyVelocityMove();
	void STATIC_ReceiveTick(float DeltaSeconds);
	void STATIC_ReceiveActorBeginOverlap(class AActor* OtherActor);
	void STATIC_ReceiveBeginPlay();
	void STATIC_Update();
	void STATIC_ExecuteUbergraph_BP_FishingBuoy_test(int EntryPoint);
};
