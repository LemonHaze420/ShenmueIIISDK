...
public:
	...
	void SetBsEnable(const struct FName& TargetCharaId, bool Enable, class UObject* __WorldContext);
	void SetBsCount(const struct FName& TargetCharaId, int EventCount, class UObject* __WorldContext);
	void IsCheckTalkSitMotion(class AActor* SitActor, class AActor* TargetActor, bool bOutputLog, class UObject* __WorldContext, bool* bPlaySit);
	void STATIC_GetTalkStartIndex(class UObject* __WorldContext, int* Index);
	void HintTalkStart(class AActor* TalkTargetNPC, class UTalkScript* TalkScript, class AActor* CurrentTargetActor, class UObject* __WorldContext, bool* Error);
	...
	void IsEjectFromTalkCamera(class UObject* __WorldContext, bool* newParam);
	void PossessTalkCamera(class UObject* __WorldContext, bool* Result);
	void EjectFromTalkCamera(class UObject* __WorldContext, bool* Result);
