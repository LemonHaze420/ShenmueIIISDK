...
// BlueprintGeneratedClass BPC_FootIKNPC.BPC_FootIKNPC_C
// 0x0098 (0x0188 - 0x00F0)
class UBPC_FootIKNPC_C : public UActorComponent
{
public:
	...
	float                                              DefaultMeshLocationZ;                                     // 0x0180(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              MoveMeshDistance;                                         // 0x0184(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BPC_FootIKNPC.BPC_FootIKNPC_C");
		return ptr;
	}
