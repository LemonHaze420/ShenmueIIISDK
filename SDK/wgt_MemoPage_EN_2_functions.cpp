...
{
	static auto fn = UObject::FindObject<UFunction>("Function wgt_MemoPage_EN_2.wgt_MemoPage_EN_1_C.Construct");
...
void Uwgt_MemoPage_EN_1_C::PushButton(const struct FVector2D& Position)
{
	static auto fn = UObject::FindObject<UFunction>("Function wgt_MemoPage_EN_2.wgt_MemoPage_EN_1_C.PushButton");

	Uwgt_MemoPage_EN_1_C_PushButton_Params params;
...
void Uwgt_MemoPage_EN_1_C::SetPageIndex(int PageIndex)
{
	...
	Uwgt_MemoPage_EN_1_C_SetPageIndex_Params params;
...
void Uwgt_MemoPage_EN_1_C::ExecuteUbergraph_wgt_MemoPage_EN_2(int EntryPoint)
{
	...
	Uwgt_MemoPage_EN_1_C_ExecuteUbergraph_wgt_MemoPage_EN_2_Params params;
