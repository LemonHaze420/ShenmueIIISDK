...
// BlueprintGeneratedClass TalkCam_SelectCloseUpCameras.TalkCam_SelectCloseUpCameras_C
// 0x0040 (0x00F0 - 0x00B0)
class UTalkCam_SelectCloseUpCameras_C : public UTalkCam_BaseTask_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass TalkCam_SelectCloseUpCameras.TalkCam_SelectCloseUpCameras_C");
		return ptr;
	}
