...
// (Net, NetReliable, Native, Event, NetMulticast, Private, BlueprintEvent, BlueprintPure)
...
// (NetRequest, Event, NetResponse, Static, NetMulticast, Public, Protected, HasOutParms, DLLImport, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// int                            EntryPoint                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_TalkCamera_PBH_01_C::STATIC_ExecuteUbergraph_BP_TalkCamera_PBH_01(int EntryPoint)
{
