...
struct ABP_MiniGame_KungFuBase_Input_C_UserConstructionScript_Params
{
};

// Function BP_MiniGame_KungFuBase_Input.BP_MiniGame_KungFuBase_Input_C.InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_8
struct ABP_MiniGame_KungFuBase_Input_C_InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_8_Params
{
...
struct ABP_MiniGame_KungFuBase_Input_C_InpActEvt_MG_Top_K2Node_InputActionEvent_7_Params
{
	struct FKey                                        Key;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function BP_MiniGame_KungFuBase_Input.BP_MiniGame_KungFuBase_Input_C.InpActEvt_MG_Bottom_K2Node_InputActionEvent_6
struct ABP_MiniGame_KungFuBase_Input_C_InpActEvt_MG_Bottom_K2Node_InputActionEvent_6_Params
{
	struct FKey                                        Key;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function BP_MiniGame_KungFuBase_Input.BP_MiniGame_KungFuBase_Input_C.InpActEvt_MG_ButtonBottom_K2Node_InputActionEvent_5
struct ABP_MiniGame_KungFuBase_Input_C_InpActEvt_MG_ButtonBottom_K2Node_InputActionEvent_5_Params
{
	struct FKey                                        Key;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function BP_MiniGame_KungFuBase_Input.BP_MiniGame_KungFuBase_Input_C.ExecuteUbergraph_BP_MiniGame_KungFuBase_Input
struct ABP_MiniGame_KungFuBase_Input_C_ExecuteUbergraph_BP_MiniGame_KungFuBase_Input_Params
{
