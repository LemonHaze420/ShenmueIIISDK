...
public:
	...
	void AddKunFuLevel(TEnumAsByte<E_MiniGame_KungFuType> Category, int AddNum);
	void BndEvt__BW_DebugBattleListStat_K2Node_ComponentBoundEvent_2_OnMax__DelegateSignature();
	void BndEvt__BW_DebugBattleListStat_C_0_K2Node_ComponentBoundEvent_3_OnPlus__DelegateSignature();
	void BndEvt__BW_DebugBattleListStat_C_0_K2Node_ComponentBoundEvent_4_OnMinus__DelegateSignature();
	void BndEvt__BW_DebugBattleListStat_C_0_K2Node_ComponentBoundEvent_5_OnMax__DelegateSignature();
	void BndEvt__BW_DebugBattleListStat_C_1_K2Node_ComponentBoundEvent_6_OnPlus__DelegateSignature();
	void BndEvt__BW_DebugBattleListStat_C_1_K2Node_ComponentBoundEvent_7_OnMinus__DelegateSignature();
	void BndEvt__BW_DebugBattleListStat_C_1_K2Node_ComponentBoundEvent_8_OnMax__DelegateSignature();
	void BndEvt__BW_DebugBattleListStat_K2Node_ComponentBoundEvent_1_OnMinus__DelegateSignature();
	void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
	void BndEvt__BW_DebugBattleListStat_K2Node_ComponentBoundEvent_0_OnPlus__DelegateSignature();
	void BndEvt__TotalLevel_K2Node_ComponentBoundEvent_9_OnPlus__DelegateSignature();
	void BndEvt__TotalLevel_K2Node_ComponentBoundEvent_10_OnMinus__DelegateSignature();
	void BndEvt__TotalLevel_K2Node_ComponentBoundEvent_11_OnMax__DelegateSignature();
	void BndEvt__UedeMinRate_K2Node_ComponentBoundEvent_792_OnPlusMin__DelegateSignature();
	void BndEvt__UedeMinRate_K2Node_ComponentBoundEvent_814_OnMinusMin__DelegateSignature();
	void BndEvt__UedeMinRate_K2Node_ComponentBoundEvent_834_OnPlusMax__DelegateSignature();
	void BndEvt__UedeMinRate_K2Node_ComponentBoundEvent_852_OnMinusMax__DelegateSignature();
	void BndEvt__KachoMinRate_K2Node_ComponentBoundEvent_868_OnPlusMin__DelegateSignature();
	void BndEvt__KachoMinRate_K2Node_ComponentBoundEvent_894_OnMinusMin__DelegateSignature();
	void BndEvt__KachoMinRate_K2Node_ComponentBoundEvent_918_OnPlusMax__DelegateSignature();
	void BndEvt__KachoMinRate_K2Node_ComponentBoundEvent_940_OnMinusMax__DelegateSignature();
	void BndEvt__KachoFortuneMinRate_K2Node_ComponentBoundEvent_960_OnPlusMin__DelegateSignature();
	void BndEvt__KachoFortuneMinRate_K2Node_ComponentBoundEvent_990_OnMinusMin__DelegateSignature();
	void BndEvt__KachoFortuneMinRate_K2Node_ComponentBoundEvent_1018_OnPlusMax__DelegateSignature();
	void BndEvt__KachoFortuneMinRate_K2Node_ComponentBoundEvent_1044_OnMinusMax__DelegateSignature();
	void PreConstruct(bool IsDesignTime);
	void BndEvt__AllOpenForkliftContainerButton_K2Node_ComponentBoundEvent_12_OnButtonClickedEvent__DelegateSignature();
