...
public:
	...
	class UTexture2D* GetPlatformDpadImage_ByIndex(TEnumAsByte<EDpadButtonImageStyle> Style, ES3PadButtonIndex Index, class UObject* __WorldContext);
	...
	class UTexture2D* GetPlatformFullDpadImage(class UObject* __WorldContext);
	class UTexture2D* GetCancelButtonImage(TEnumAsByte<EFaceButtonImageStyle> Style, class UObject* __WorldContext);
	class UTexture2D* GetConfirmButtonImage(TEnumAsByte<EFaceButtonImageStyle> Style, class UObject* __WorldContext);
	...
	class UBP_GamePadShoulderSetAsset_C* GetShoulderSetAsset(TEnumAsByte<EShoulderButtonStyle> Style, ES3Platform Platform, class UObject* __WorldContext);
	...
	void GetGamePadImageSet(ES3Platform Platform, class UObject* __WorldContext, class UBP_GamePadImageSetAsset_C** SET);
	...
	void GetPopPlatformButtonImage(bool Absolute, class UObject* __WorldContext, class UTexture2D** ButtonA, class UTexture2D** ButtonB, class UTexture2D** ButtonX, class UTexture2D** ButtonY, class UTexture2D** ButtonBlank);
	void GetDefaultPlatformButtonImage(bool Absolute, class UObject* __WorldContext, class UTexture2D** ButtonA, class UTexture2D** ButtonB, class UTexture2D** ButtonX, class UTexture2D** ButtonY, class UTexture2D** ButtonBlank);
	...
	void GetFaceButtonImage(TEnumAsByte<EFaceButtonImageStyle> Style, ES3Platform Platform, class UObject* __WorldContext, class UTexture2D** ButtonA, class UTexture2D** Button_B, class UTexture2D** ButtonX, class UTexture2D** ButtonY, class UTexture2D** ButtonBlank);
	void GetPlatformDpadImage(class UObject* __WorldContext, class UTexture2D** DpadUP, class UTexture2D** dpadDOWN, class UTexture2D** dpadRIGHT, class UTexture2D** dpadLEFT, class UTexture2D** DpadNEUTRAL);
