...
struct UBP_S3SaveLoadTestButton_C_SetDateTime_Params
{
...
struct UBP_S3SaveLoadTestButton_C_SetOptionText_Params
{
	struct FString                                     Text;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor)
};

// Function BP_S3SaveLoadTestButton.BP_S3SaveLoadTestButton_C.SetStep
struct UBP_S3SaveLoadTestButton_C_SetStep_Params
{
...
struct UBP_S3SaveLoadTestButton_C_Construct_Params
{
};
...
struct UBP_S3SaveLoadTestButton_C_BndEvt__Button_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function BP_S3SaveLoadTestButton.BP_S3SaveLoadTestButton_C.ExecuteUbergraph_BP_S3SaveLoadTestButton
struct UBP_S3SaveLoadTestButton_C_ExecuteUbergraph_BP_S3SaveLoadTestButton_Params
{
	int                                                EntryPoint;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_S3SaveLoadTestButton.BP_S3SaveLoadTestButton_C.OnClicked__DelegateSignature
struct UBP_S3SaveLoadTestButton_C_OnClicked__DelegateSignature_Params
{
};
