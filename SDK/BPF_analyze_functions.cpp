...
// float                          MaxAbove                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// float                          MaxBelow                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// float                          Radius                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UObject*                 __WorldContext                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// float                          ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

float UBPF_analyze_C::STATIC_EstimateGroundHeight(class ACharacter* Pawn, const struct FVector& Location, float MaxAbove, float MaxBelow, float Radius, class UObject* __WorldContext)
{
	static auto fn = UObject::FindObject<UFunction>("Function BPF_analyze.BPF_analyze_C.EstimateGroundHeight");

	UBPF_analyze_C_EstimateGroundHeight_Params params;
	params.Pawn = Pawn;
