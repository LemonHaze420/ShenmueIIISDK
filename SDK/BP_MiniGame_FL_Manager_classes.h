...
public:
	...
	void GetLoadLevelData(bool* Found, struct FST_MiniGame_FL_Difficulty* FST_MiniGame_FL_Difficulty_var);
	void GetDataTableByName(const struct FName& RowName, bool* Found, struct FST_MiniGame_FL_Difficulty* FST_MiniGame_FL_Difficulty_var);
