...
// BlueprintGeneratedClass BP_State_LookAtNPC_Animation.BP_State_LookAtNPC_Animation_C
// 0x0013 (0x006C - 0x0059)
class UBP_State_LookAtNPC_Animation_C : public UBP_State_LookAtNPC_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_State_LookAtNPC_Animation.BP_State_LookAtNPC_Animation_C");
		return ptr;
	}
