...
// WidgetBlueprintGeneratedClass BPW_SelectElem.BPW_SelectElem_C
// 0x0010 (0x0218 - 0x0208)
class UBPW_SelectElem_C : public UUserWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass BPW_SelectElem.BPW_SelectElem_C");
		return ptr;
	}
