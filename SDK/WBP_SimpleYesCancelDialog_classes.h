...
public:
	...
	void STATIC_RequestSelectRight();
	void STATIC_RequestSelectLeft();
	void STATIC_RequestSelect(bool InIsLeft);
	void STATIC_IsSelectable(bool* newParam);
	void IsClosable(bool* newParam);
	void STATIC_IsOpenable(bool* newParam);
	void OnFinishedCloseAnimation();
	void Close();
	void Open();
	bool STATIC_IsYesSelected();
	void STATIC_Finalize();
	void Initialize();
	void STATIC_Construct();
	void STATIC_Destruct();
	void STATIC_ExecuteUbergraph_WBP_SimpleYesCancelDialog(int EntryPoint);
