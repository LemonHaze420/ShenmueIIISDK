...
// Function BP_BG_Neon.BP_BG_Neon_C.ExecuteUbergraph_BP_BG_Neon
// (HasDefaults)
// Parameters:
// int                            EntryPoint                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_BG_Neon_C::ExecuteUbergraph_BP_BG_Neon(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_BG_Neon.BP_BG_Neon_C.ExecuteUbergraph_BP_BG_Neon");

	ABP_BG_Neon_C_ExecuteUbergraph_BP_BG_Neon_Params params;
