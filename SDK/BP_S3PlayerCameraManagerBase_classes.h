...
public:
	...
	void STATIC_SetControlRotationYaw(float Yaw);
	struct FRotator GetControlRotation();
	float StandardGateMouseLook(float In);
	void STATIC_SetActiveFocusSign(bool Active);
	bool GetIsZoomingInFOV();
	void STATIC_SetEnabledAttentionSearch(bool Enabled);
	void ResetCameraPitchLimit(bool Immediately);
	float STATIC_PanInterp(float Current, float Max, float Speed, float InputStr);
	void STATIC_SetControlRotation(const struct FRotator& NewRotation);
	void STATIC_EnableFaceFocusMode(bool bSetEnabled);
	void STATIC_Debug_EnableFaceFocusMode(bool bSetEnabled);
	void STATIC_IsFaceFocusModeEnabled(bool* bIsEnabled);
	void ZoomLookAtChar(class AS3Character* InCharacter, bool* bValid);
	void STATIC_ZoomLookAtTalkChar(bool* bValidChar);
	void STATIC_InitZoomRotation();
	void GetZoomTargetCharacter(class AS3Character** OutCharacter);
	void STATIC_GetLookAtRotation(const struct FRotator& FallbackRotation, struct FRotator* OutRotation);
	void STATIC_StopLookAtLocation();
	...
	void STATIC_SetRotationOffset(const struct FRotator& Offset);
	void SetPlayerBehindSmooth(bool Smooth);
	void STATIC_UpdateSpringArmLagFlag();
	...
	void STATIC_UpdateSpringArmSocket();
	void UpdateZoomState(float ZoomInputAxis);
	void InterpolateAngleNear(float SrcAngle, float DstAngle, float Ratio, float* Result);
	void STATIC_InterpolateAngle(float SrcAngle, float DstAngle, float Ratio, bool Positive, float* Result);
	void STATIC_GetAngleNormal(float SrcAngleDeg, float* DstAngleDeg);
	void STATIC_IsReversedSignIfAdd(float BaseParam, float AddParam, bool* Reversed);
	void STATIC_SetPlayerBehind();
	void STATIC_IsZoomEnable(bool* Enable);
	void ResetZoom(bool WithState);
	void IsFirstPersonView(bool* FirstPerson);
	void STATIC_SwitchZoomState(float AxisValue);
	void CalcThirdPersonCamera();
	void IsAttention(bool* Attention);
	void STATIC_TickZoomCameraRotation();
	...
	void STATIC_CameraSpringArmLagSet(bool flag);
	void STATIC_IsCameraCollision(bool* CollisionFlag);
	void STATIC_CameraCollisionOff();
	void STATIC_CameraCollisionOn();
	void STATIC_CameraCalcOff();
	void STATIC_CameraCalcOn();
	void CameraRotInitParam();
	void STATIC_CameraRotInit();
	void UserConstructionScript();
	void STATIC_InpActEvt_Screenshot_K2Node_InputActionEvent_8(const struct FKey& Key);
	void STATIC_InpActEvt_ScreenshotCine_K2Node_InputActionEvent_7(const struct FKey& Key);
	void STATIC_InpActEvt_ResetCamera_K2Node_InputActionEvent_6(const struct FKey& Key);
	void STATIC_InpActEvt_ResetCamera_K2Node_InputActionEvent_5(const struct FKey& Key);
	void STATIC_ReceiveTick(float DeltaSeconds);
	void STATIC_ReceiveBeginPlay();
	void STATIC_OnPhotographySessionStart();
	void STATIC_OnPhotographySessionEnd();
	void STATIC_InputHeldResetCamera();
	void STATIC_InpAxisEvt_LookUp_K2Node_InputAxisEvent_7(float AxisValue);
	void STATIC_InpAxisEvt_Turn_K2Node_InputAxisEvent_18(float AxisValue);
	void STATIC_ReceiveEndPlay(TEnumAsByte<EEndPlayReason> EndPlayReason);
	void STATIC_CleanupNullReferences();
	void STATIC_ChangedCameraState(ECameraState OldState, ECameraState NewState);
	void STATIC_InpAxisEvt_MouseLook_X_K2Node_InputAxisEvent_3(float AxisValue);
	void STATIC_InpAxisEvt_MouseLook_Y_K2Node_InputAxisEvent_4(float AxisValue);
