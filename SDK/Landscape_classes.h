...
public:
	...
	TArray<class UMaterialInterface*>                  LandscapeLODMaterials;                                    // 0x0390(0x0010) (Edit, ZeroConstructor)
	class UMaterialInterface*                          LandscapeHoleMaterial;                                    // 0x03A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<class UMaterialInterface*>                  LandscapeHoleLODMaterials;                                // 0x03A8(0x0010) (Edit, ZeroConstructor)
	...
	struct FBodyInstance                               BodyInstance;                                             // 0x0498(0x0158) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bGenerateOverlapEvents : 1;                               // 0x05F0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly)
	unsigned char                                      bBakeMaterialPositionOffsetIntoCollision : 1;             // 0x05F0(0x0001) (Edit)
	unsigned char                                      UnknownData10[0x3];                                       // 0x05F1(0x0003) MISSED OFFSET
	int                                                ComponentSizeQuads;                                       // 0x05F4(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                SubsectionSizeQuads;                                      // 0x05F8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                NumSubsections;                                           // 0x05FC(0x0004) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUsedForNavigation : 1;                                   // 0x0600(0x0001) (Edit)
	unsigned char                                      UnknownData11[0x3];                                       // 0x0601(0x0003) MISSED OFFSET
	bool                                               bUseDynamicMaterialInstance;                              // 0x0604(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ENavDataGatheringMode                              NavigationGeometryGatheringMode;                          // 0x0605(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	bool                                               bUseLandscapeForCullingInvisibleHLODVertices;             // 0x0606(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData12[0x51];                                      // 0x0607(0x0051) MISSED OFFSET
...
public:
	...
	TArray<class UMaterialInterface*>                  OverrideLODMaterials;                                     // 0x0580(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	class UMaterialInterface*                          OverrideHoleMaterial;                                     // 0x0590(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UMaterialInterface*>                  OverrideHoleLODMaterials;                                 // 0x0598(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
...
{
public:
	TLazyObjectPtr<class ALandscape>                   LandscapeActor;                                           // 0x0658(0x001C) (Edit, IsPlainOldData)
