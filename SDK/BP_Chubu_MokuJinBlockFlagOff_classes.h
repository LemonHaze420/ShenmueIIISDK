...
// BlueprintGeneratedClass BP_Chubu_MokuJinBlockFlagOff.BP_Chubu_MokuJinBlockFlagOff_C
// 0x0020 (0x0348 - 0x0328)
class ABP_Chubu_MokuJinBlockFlagOff_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Chubu_MokuJinBlockFlagOff.BP_Chubu_MokuJinBlockFlagOff_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_Chubu_MokuJinBlockFlagOff(int EntryPoint);
};
