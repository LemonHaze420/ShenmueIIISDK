...
public:
	...
	float                                              TimeSinceTalkStart;                                       // 0x1718(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               bDelaySkip;                                               // 0x171C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void SetCanSkip(bool Skip);
	bool IsStreetFightScript();
	void IsIgonoreShe(bool* Ignore);
	void SetDisableAnsel(bool Disable);
	void ExecMuteSoundTask(class UMuteFadeSoundTask* MuteSoundTask);
	void StopForceSkip();
	...
	void InpActEvt_Shift_C_K2Node_InputKeyEvent_6(const struct FKey& Key);
	void InpActEvt_Ctrl_Q_K2Node_InputKeyEvent_5(const struct FKey& Key);
	void InpActEvt_Shift_K_K2Node_InputKeyEvent_4(const struct FKey& Key);
