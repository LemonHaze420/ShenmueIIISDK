...
// BlueprintGeneratedClass BP_MiniGame_QteTriangleLowerRight.BP_MiniGame_QteTriangleLowerRight_C
// 0x004C (0x0374 - 0x0328)
class ABP_MiniGame_QteTriangleLowerRight_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MiniGame_QteTriangleLowerRight.BP_MiniGame_QteTriangleLowerRight_C");
		return ptr;
	}
