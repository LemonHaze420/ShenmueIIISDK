...
public:
	...
	void STATIC_MakeLead_New();
	void STATIC_MakeFlwOrNpc_New(bool Set_ExspPos, bool Set_ExspPos_B);
	void CheckSHEhouseIn(bool* house_in);
	void STATIC_CheckWaitCondtion(bool* Wait_On);
	...
	void STATIC_Test_MsgEvent(TEnumAsByte<EN_MainFlowMsgDestinationID> Current_Destination_ID);
	...
	void STATIC_OnEndOverlap_JoinArea(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex);
	...
	void STATIC_ExecuteUbergraph_BP_Hakkason_SHEseparation(int EntryPoint);
};
