...
public:
	...
	bool BPF_GetSkillText(int Index, class UObject* __WorldContext, struct FST_SkillTextData* TextData);
	void BPF_SortSkillItemsForDisplay(class UBTL_CommandLibrary_C* SkillLibrary, class US3GameInstance* Inventory, bool EquippableOnly, class UObject* __WorldContext, TArray<int>* SortedInts);
	void STATIC_BPF_ConvertSkillNameListToIntList(TArray<int> Ints, class UObject* __WorldContext, TArray<struct FName>* Names);
	void GetNonItemSkillName_Int32(int ID, class UObject* __WorldContext, struct FString* NameText, struct FString* GraphicText);
	void BPF_SelectAutoSkillSetAsFallback(class UBTL_CommandLibrary_C* CommandLibrary, class UObject* __WorldContext);
	void BPF_ListLevelableSkills_int(class UBTL_CommandLibrary_C* SkillLibrary, class UObject* __WorldContext, TArray<int>* SkillItems);
	...
	void BPF_ListPlayerSkillItems_Name(class UBTL_CommandLibrary_C* SkillLibrary, class US3GameInstance* Inventory, bool EquippableOnly, bool Sort, class UObject* __WorldContext, TArray<struct FName>* SortedList);
	void BPF_ListLevelableSkills_Name(class UBTL_CommandLibrary_C* SkillLibrary, class UObject* __WorldContext, TArray<struct FName>* SkillItems);
	struct FText BPF_CalcSelectedSkillsetName(const struct FText& TextData, class UObject* __WorldContext, int* Index);
	bool BPF_IsSkillLevelable(class UBTL_CommandLibrary_C* CommandLibrary, const struct FName& SkillItem, class UObject* __WorldContext);
	...
	void BPF_SelectAutoSkillSet(class UObject* __WorldContext);
	void BPF_SelectSkillSet(int Index, class UObject* __WorldContext);
	...
	void BPF_EquipSkill(const struct FName& SkillId, int Index, class UObject* __WorldContext);
	void BPF_SelectRecommendedSkillList(class UBTL_CommandLibrary_C* CommandLibrary, TEnumAsByte<ESkillRecommendationType> Type, class UObject* __WorldContext, TArray<struct FName>* ItemLabels);
	void BPF_ConvertItemIDToSkillID_Fast(int Int, class UObject* __WorldContext, struct FName* Name);
