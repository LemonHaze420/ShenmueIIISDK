...
public:
	...
	void BPF_GetCharacterTop(class ACharacter* Character, class UObject* __WorldContext, struct FVector* Bottom);
	void BPF_WorldSpaceYawToDirection(float Yaw, class UObject* __WorldContext, struct FVector* Direction);
	int STATIC_BPF_IntStepTo(int Current, int Target, class UObject* __WorldContext);
	struct FRotator BPF_FindActor2DLookAtRotation(class AActor* Start, class AActor* Target, class UObject* __WorldContext);
	struct FRotator BPF_Find2DLookAtRotation(const struct FVector& Start, const struct FVector& Target, class UObject* __WorldContext);
	...
	void BPF_GetCharacterBottom(class ACharacter* Character, class UObject* __WorldContext, struct FVector* Bottom);
	...
	void BPF_RemoveVectorZ(const struct FVector& InVector, class UObject* __WorldContext, struct FVector* OutVector);
	...
	void BPF_DirectionToWorldSpaceYaw(const struct FVector& Direction, class UObject* __WorldContext, float* WorldSpaceYaw);
	...
	void BPF_GetSplineAreaAtPointVector3D(const struct FVector& Offset, class UObject* __WorldContext, TArray<struct FVector>* PointVector, struct FBox* OutBounds);
	...
	struct FRotator BPF_RInterpToQuaternionLinear(const struct FRotator& Current, const struct FRotator& Target, float DeltaTime, float InterpSpeed, class UObject* __WorldContext);
	...
	void BPF_GetSplineRate(class AActor* Actor, float MoveDistance, class UObject* __WorldContext, float* Rate);
	void BPF_GetSplineAreaAtSpline(class AActor* Actor, float Offset, class UObject* __WorldContext, float* x_max, float* x_min, float* y_max, float* y_min);
	...
	void BPF_Length1d(float V0, float v1, class UObject* __WorldContext, float* Length);
	...
	void BPF_InterVector(const struct FVector& v1, const struct FVector& v2, float Rate, class UObject* __WorldContext, struct FVector* V0);
	...
	void BPF_LineWrongSideOut2d(float PosX, float PosY, float Vx0, float Vy0, float Vx1, float Vy1, class UObject* __WorldContext, bool* DstFlag);
	void BPF_AngleVector(const struct FVector& v1, const struct FVector& v2, class UObject* __WorldContext, float* RetRot);
	...
	void BPF_LineDirection(const struct FVector& V0, const struct FVector& v1, class UObject* __WorldContext, struct FVector* Dst);
	void BPF_DeltaTimeScale(float Scale, class UObject* __WorldContext, float* Dst);
	void stringCompare(const struct FString& stringA, const struct FString& stringB, bool i, class UObject* __WorldContext, int* Result);
	void BPF_TraceIdast1dDeltaTime(float V, float TergetV, float Speed, class UObject* __WorldContext, float* Dst);
