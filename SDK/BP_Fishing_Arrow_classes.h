...
public:
	...
	void STATIC_CheckWaterHeightUseVal(struct FVector* HitPos);
	void STATIC_CheckWaterHeight(struct FVector* HitPos);
	void End8Move();
	void Start8Move();
	void STATIC_Update8Move();
	void STATIC_GetWaterAndArrowIntersectPos(struct FVector* HitPos);
	...
	void STATIC_ExecuteUbergraph_BP_Fishing_Arrow(int EntryPoint);
};
