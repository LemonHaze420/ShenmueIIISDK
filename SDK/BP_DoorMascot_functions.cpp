...
// Function BP_DoorMascot.BP_DoorMascot_C.ExecuteUbergraph_BP_DoorMascot
// (HasDefaults)
// Parameters:
// int                            EntryPoint                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_DoorMascot_C::ExecuteUbergraph_BP_DoorMascot(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_DoorMascot.BP_DoorMascot_C.ExecuteUbergraph_BP_DoorMascot");

	ABP_DoorMascot_C_ExecuteUbergraph_BP_DoorMascot_Params params;
