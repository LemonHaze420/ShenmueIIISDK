...
void ABP_MiniGame_FL_Manager_C::GetLoadLevelData(bool* Found, struct FST_MiniGame_FL_Difficulty* FST_MiniGame_FL_Difficulty_var)
{
	...
	if (Found != nullptr)
		*Found = params.Found;
	if (FST_MiniGame_FL_Difficulty_var != nullptr)
		*FST_MiniGame_FL_Difficulty_var = params.FST_MiniGame_FL_Difficulty_var;
}
...
void ABP_MiniGame_FL_Manager_C::GetDataTableByName(const struct FName& RowName, bool* Found, struct FST_MiniGame_FL_Difficulty* FST_MiniGame_FL_Difficulty_var)
{
