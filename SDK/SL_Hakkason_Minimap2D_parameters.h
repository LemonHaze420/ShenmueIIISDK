...
struct ASL_Hakkason_Minimap2D_C_BndEvt__TriggerBox_Sunflowerfield_K2Node_ActorBoundEvent_0_ActorBeginOverlapSignature__DelegateSignature_Params
{
...
struct ASL_Hakkason_Minimap2D_C_BndEvt__TriggerBox_Sunflowerfield_K2Node_ActorBoundEvent_1_ActorEndOverlapSignature__DelegateSignature_Params
{
	class AActor*                                      OverlappedActor;                                          // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
	class AActor*                                      OtherActor;                                               // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};
...
struct ASL_Hakkason_Minimap2D_C_ExecuteUbergraph_SL_Hakkason_Minimap2D_Params
{
