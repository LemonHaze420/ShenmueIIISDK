...
struct UBP_AnimNotifyState_DisableLookAt_C_GetNotifyName_Params
{
	struct FString                                     ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm)
};

// Function BP_AnimNotifyState_DisableLookAt.BP_AnimNotifyState_DisableLookAt_C.Received_NotifyEnd
struct UBP_AnimNotifyState_DisableLookAt_C_Received_NotifyEnd_Params
{
...
struct UBP_AnimNotifyState_DisableLookAt_C_Received_NotifyBegin_Params
{
	class USkeletalMeshComponent*                      MeshComp;                                                 // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAnimSequenceBase*                           Animation;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
