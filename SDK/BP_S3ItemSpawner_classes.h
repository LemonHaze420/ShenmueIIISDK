...
public:
	...
	void STATIC_SetAquisitionItem();
	bool STATIC_IsAcquisitionItem();
	void STATIC_InitializeSearchItemActor();
	void STATIC_IsPlayOnlyLookScript(bool* isPlay);
	void STATIC_GetUniqueCameraTransform(struct FTransform* Transform);
	void IsLooking(bool* Look);
	void STATIC_GetCameraLocationOffset(struct FVector* CameraLocationOffset);
	struct FName GetItemIDAsName();
	void UniqueActionOnFind();
	void ForceFindSelf();
	void RemovalItem();
	void STATIC_IsCompleted(bool* bCompleted);
	bool InFront();
	void MyDestructor();
	...
	void SetSearchStep();
	void STATIC_SwitchTarget();
	void STATIC_IsCurrentItem(bool* Result);
	void STATIC_IsOverlappingPlayer(class UObject* Object, bool* RangeFlag, bool* Result);
	...
	void CreateEffect();
	void STATIC_CalcCameraTransform();
	void Initialize(bool* Enable);
	void UserConstructionScript();
	void STATIC_ReceiveBeginPlay();
	void STATIC_ReceiveTick(float DeltaSeconds);
	void STATIC_BndEvt__HitCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void STATIC_BndEvt__GetCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void STATIC_BndEvt__WakeupCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void STATIC_BndEvt__HelpReactCollision_K2Node_ComponentBoundEvent_5_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex, bool bFromSweep, const struct FHitResult& SweepResult);
	...
	void STATIC_BeginActionVisibleAndFound();
