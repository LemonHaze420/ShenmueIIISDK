...
// BlueprintGeneratedClass BP_State_LookAtNPC_Walk.BP_State_LookAtNPC_Walk_C
// 0x0013 (0x006C - 0x0059)
class UBP_State_LookAtNPC_Walk_C : public UBP_State_LookAtNPC_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_State_LookAtNPC_Walk.BP_State_LookAtNPC_Walk_C");
		return ptr;
	}
