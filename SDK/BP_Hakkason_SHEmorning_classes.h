...
public:
	...
	void STATIC_TalkACSelect(class UTalkScript** select_ac);
	...
	void STATIC_ChangeDirection_AreaTrg(bool Positive_direction, float Impact_dot_Arrow);
	void TickChangeCheckKill();
	void STATIC_ExecuteUbergraph_BP_Hakkason_SHEmorning(int EntryPoint);
};
