...
struct ABP_Fishing_Input_Test_C_UserConstructionScript_Params
{
};

// Function BP_Fishing_Input_Test.BP_Fishing_Input_Test_C.InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_4
struct ABP_Fishing_Input_Test_C_InpActEvt_MG_ButtonRight_K2Node_InputActionEvent_4_Params
{
	struct FKey                                        Key;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function BP_Fishing_Input_Test.BP_Fishing_Input_Test_C.InpActEvt_MG_ButtonBottom_K2Node_InputActionEvent_3
struct ABP_Fishing_Input_Test_C_InpActEvt_MG_ButtonBottom_K2Node_InputActionEvent_3_Params
{
	struct FKey                                        Key;                                                      // (BlueprintVisible, BlueprintReadOnly, Parm)
};

// Function BP_Fishing_Input_Test.BP_Fishing_Input_Test_C.InpAxisEvt_MG_RightStickHorizontal_K2Node_InputAxisEvent_1
struct ABP_Fishing_Input_Test_C_InpAxisEvt_MG_RightStickHorizontal_K2Node_InputAxisEvent_1_Params
{
...
struct ABP_Fishing_Input_Test_C_InpAxisEvt_MG_RightStickVertical_K2Node_InputAxisEvent_3_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_Fishing_Input_Test.BP_Fishing_Input_Test_C.InpAxisEvt_MG_LeftStickHorizontal_K2Node_InputAxisEvent_7
struct ABP_Fishing_Input_Test_C_InpAxisEvt_MG_LeftStickHorizontal_K2Node_InputAxisEvent_7_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_Fishing_Input_Test.BP_Fishing_Input_Test_C.InpAxisEvt_MG_LeftStickVertical_K2Node_InputAxisEvent_13
struct ABP_Fishing_Input_Test_C_InpAxisEvt_MG_LeftStickVertical_K2Node_InputAxisEvent_13_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_Fishing_Input_Test.BP_Fishing_Input_Test_C.ExecuteUbergraph_BP_Fishing_Input_Test
struct ABP_Fishing_Input_Test_C_ExecuteUbergraph_BP_Fishing_Input_Test_Params
{
