...
struct ABP_MiniGame_Keiho_Input_C_InpAxisEvt_MG_RightStickVertical_K2Node_InputAxisEvent_24_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_MiniGame_Keiho_Input.BP_MiniGame_Keiho_Input_C.InpAxisEvt_MG_LeftStickHorizontal_K2Node_InputAxisEvent_13
struct ABP_MiniGame_Keiho_Input_C_InpAxisEvt_MG_LeftStickHorizontal_K2Node_InputAxisEvent_13_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_MiniGame_Keiho_Input.BP_MiniGame_Keiho_Input_C.InpAxisEvt_MG_LeftStickVertical_K2Node_InputAxisEvent_14
struct ABP_MiniGame_Keiho_Input_C_InpAxisEvt_MG_LeftStickVertical_K2Node_InputAxisEvent_14_Params
{
	float                                              AxisValue;                                                // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_MiniGame_Keiho_Input.BP_MiniGame_Keiho_Input_C.ExecuteUbergraph_BP_MiniGame_Keiho_Input
struct ABP_MiniGame_Keiho_Input_C_ExecuteUbergraph_BP_MiniGame_Keiho_Input_Params
{
