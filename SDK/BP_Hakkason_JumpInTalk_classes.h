...
public:
	...
	void STATIC_BeginHitCheck(class UPrimitiveComponent* TrgBox, bool* BeginIn);
	void ForcedHouseIn(bool* rc);
	void STATIC_CheckHouseInAndNeedTalk(bool* HouseInTalk);
	void STATIC_ForcedSet();
	void STATIC_CheckTalkEnd(bool* talk_end);
	...
	void STATIC_CheckTalkPostion(unsigned char* Postype);
	void STATIC_CheckTalkEnable(bool* TalkEnable);
	void STATIC_CheckSHEDoor(bool* UsePlayer, int* DoorType);
	void STATIC_InitSet(class UPrimitiveComponent* Door1, class UPrimitiveComponent* Door2);
	...
	void STATIC_OnEndOverlapBack(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int OtherBodyIndex);
	void ExspHouseIn();
	void STATIC_LocalEvt_ClothChange(const TScriptInterface<class US3ClothInterface>& Interface, const struct FName& CharaName);
