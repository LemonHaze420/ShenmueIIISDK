...
void ABP_TalkCamera_SBH_09_C::STATIC_UserConstructionScript()
{
...
// (Net, NetReliable, Exec, Event, Static, NetMulticast, Private, NetServer, HasDefaults, NetClient, DLLImport, BlueprintEvent, BlueprintPure)

void ABP_TalkCamera_SBH_09_C::STATIC_ReceiveBeginPlay()
{
...
// (Net, NetRequest, Public, Private, NetClient, BlueprintCallable, BlueprintPure, Const)
// Parameters:
...
// (NetReliable, Native, Event, NetResponse, Static, Public, Private, Delegate, NetClient, DLLImport, BlueprintCallable, BlueprintPure)
// Parameters:
// int                            EntryPoint                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_TalkCamera_SBH_09_C::STATIC_ExecuteUbergraph_BP_TalkCamera_SBH_09(int EntryPoint)
{
