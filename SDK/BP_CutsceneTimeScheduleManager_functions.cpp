...
void ABP_CutsceneTimeScheduleManager_C::GetCurrentStockEvent(struct FName* newParam)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_CutsceneTimeScheduleManager.BP_CutsceneTimeScheduleManager_C.GetCurrentStockEvent");

	ABP_CutsceneTimeScheduleManager_C_GetCurrentStockEvent_Params params;
