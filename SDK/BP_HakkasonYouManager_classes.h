...
public:
	...
	void STATIC_ChengeHanautaCollisionSize();
	void CheckEventFalg(int Index);
	void STATIC_CheckYouHouseSyoji(bool Open);
	...
	void STATIC_BindNPCManager();
	void ChangeDayTime(ES3DayTimeEvent EventType);
	void STATIC_ReceiveBeginPlay();
	void STATIC_CheckNPCflagChange(int ArrayIndex, int SetFlags);
	void CheckStepChange(int SetSteps);
	void STATIC_ChangeBehavior(ES3PlayerBehavior NewId, ES3PlayerBehavior OldId);
	void STATIC_StartTalk();
	void STATIC_EndTalk();
	void STATIC_ExecuteUbergraph_BP_HakkasonYouManager(int EntryPoint);
};
